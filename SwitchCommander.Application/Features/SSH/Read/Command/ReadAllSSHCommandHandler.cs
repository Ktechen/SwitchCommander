...
public class
    ReadAllSSHCommandHandler : IRequestHandler<ReadAllSSHCommandRequest, IEnumerable<ReadAllSSHCommandResponse>>
{
    ...
    public ReadAllSSHCommandHandler(ILogger<ReadAllSSHCommandHandler> logger,
    ...
    public async Task<IEnumerable<ReadAllSSHCommandResponse>> Handle(ReadAllSSHCommandRequest request,
